...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent requireScreenTextureText = EditorGUIUtility.TrTextContent("Screen Texture", "If enabled the pipeline will copy the screen to texture after postprocess objects are drawn. For transparent objects this can be bound in shaders as _CameraScreenTexture.");
            ...
            public static GUIContent mainLightShadowGradient = EditorGUIUtility.TrTextContent("Gradient", "If enabled pipeline will perform Shadow Gradient.");
            public static GUIContent supportsShadowRamp = EditorGUIUtility.TrTextContent("Shadow Ramp", "If enabled pipeline will perform Shadow Ramp.");
